...
results/01-blast-search/output/GOS_assemblies_containing_photo_genes.fas: results/01-blast-search/output/psaA_in_GOS_tblastx.xml results/01-blast-search/output/psbA_in_GOS_tblastx.xml
	./results/01-blast-search/scripts/fetchBlastHitSequences.py ./results/01-blast-search/output/psaA_in_GOS_tblastx.xml ./data/input.fasta ./results/01-blast-search/output/GOS_assemblies_containing_psaA.fas
